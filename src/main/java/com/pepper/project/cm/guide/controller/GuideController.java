...
public class GuideController extends BaseController {
    ...
    @RequiresPermissions("csc:guide:view")
    @GetMapping()
    ...
    @RequiresPermissions("csc:guide:list")
    @PostMapping("/list")
    @ResponseBody
    ...
    @RequiresPermissions("csc:guide:add")
    @PostMapping("/add")
    @ResponseBody
     ...
     * 修改保存公告
     */
    @RequiresPermissions("csc:guide:edit")
     ...
     * 删除区域
     */
    @RequiresPermissions("csc:guide:remove")
