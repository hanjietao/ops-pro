...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '预约管理 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ch_doctor`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2000 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '医生管理 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ch_hospital`  (
  ...
  `COMMUNITY_IDS` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '服务的社区IDS 社区1，社区2，。。。',
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 300002 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区服务服务中心-医院介绍 ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ch_hospital
-- ----------------------------
INSERT INTO `ch_hospital` VALUES (300000, 'hostest,医院管理员', '300000', '这是一个医院！', NULL, '100000', '0', 'admin', '2020-03-01 15:26:05', 'admin', '2020-03-01 15:29:54');
INSERT INTO `ch_hospital` VALUES (300001, 'hostest1,医院管理员', '300001', '这是一个医院！', NULL, '100000', '0', 'admin', '2020-03-01 15:32:42', 'admin', '2020-03-01 15:32:42');
...
CREATE TABLE `ch_medical_project`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '医疗项目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_activity`  (
  ...
  `COMMUNITY_ID` int(11) DEFAULT NULL COMMENT '社区',
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区活动 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_activity_apply`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区活动报名表 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_business_guide`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区办事指南 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_community`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 200001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区 ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cm_community
-- ----------------------------
INSERT INTO `cm_community` VALUES (200000, '200000', 'comutest,社区管理员', 100000, '这是一个社区！', '0', 'admin', '2020-03-01 15:24:33', 'admin', '2020-03-01 15:24:33');
...
CREATE TABLE `cm_note`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户留言社区 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `csc_area`  (
  ...
  `CREATE_TIME` datetime(0) DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区服务服务中心-区域设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of csc_area
-- ----------------------------
INSERT INTO `csc_area` VALUES (100000, 'SYBK', '沙依巴克区', '10.00090,89.89009', '0', 'admin', '2020-03-01 15:23:37', 'admin', '2020-03-01 15:23:37');
...
CREATE TABLE `fp_loop_image`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '首页轮播图 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `he_board`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5000 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '健康宣教板块 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `he_video`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '健康宣教宣教视频 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_activity`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物业活动 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_activity_apply`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物业活动报名 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_business_guide`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2000 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '办事指南 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_note`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户留言物业 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_notice`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物业通知 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_property`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 400001 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物业 ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pm_property
-- ----------------------------
INSERT INTO `pm_property` VALUES (400000, '400000', '物业管理员', 100000, '这是一个物业！', '0', 'admin', '2020-03-01 15:34:29', 'admin', '2020-03-01 15:34:29');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1583047640000, -1, 5, 'PAUSED', 'CRON', 1583047634000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1583047635000, -1, 5, 'PAUSED', 'CRON', 1583047634000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1583047640000, -1, 5, 'PAUSED', 'CRON', 1583047634000, 0, NULL, 2, '');
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (1, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 14:57:02');
INSERT INTO `sys_logininfor` VALUES (2, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 14:57:09');
INSERT INTO `sys_logininfor` VALUES (3, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:03:18');
INSERT INTO `sys_logininfor` VALUES (4, 'hant', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '1', '对不起，您的账号已被删除', '2020-03-01 15:03:28');
INSERT INTO `sys_logininfor` VALUES (5, 'hant', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:03:52');
INSERT INTO `sys_logininfor` VALUES (6, 'hant', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:13:56');
INSERT INTO `sys_logininfor` VALUES (7, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:14:08');
INSERT INTO `sys_logininfor` VALUES (8, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:14:23');
INSERT INTO `sys_logininfor` VALUES (9, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:17:06');
INSERT INTO `sys_logininfor` VALUES (10, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:19:15');
INSERT INTO `sys_logininfor` VALUES (11, 'hospitaltest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:19:19');
INSERT INTO `sys_logininfor` VALUES (12, 'hospitaltest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:19:57');
INSERT INTO `sys_logininfor` VALUES (13, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:23:02');
INSERT INTO `sys_logininfor` VALUES (14, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:24:36');
INSERT INTO `sys_logininfor` VALUES (15, 'comutest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:24:42');
INSERT INTO `sys_logininfor` VALUES (16, 'comutest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:24:57');
INSERT INTO `sys_logininfor` VALUES (17, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:25:04');
INSERT INTO `sys_logininfor` VALUES (18, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:26:09');
INSERT INTO `sys_logininfor` VALUES (19, 'hostest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:26:15');
INSERT INTO `sys_logininfor` VALUES (20, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:29:43');
INSERT INTO `sys_logininfor` VALUES (21, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:30:21');
INSERT INTO `sys_logininfor` VALUES (22, 'hostest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:30:25');
INSERT INTO `sys_logininfor` VALUES (23, 'hostest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:30:54');
INSERT INTO `sys_logininfor` VALUES (24, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:31:05');
INSERT INTO `sys_logininfor` VALUES (25, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:32:49');
INSERT INTO `sys_logininfor` VALUES (26, 'hostest1', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:32:53');
INSERT INTO `sys_logininfor` VALUES (27, 'hostest1', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:33:20');
INSERT INTO `sys_logininfor` VALUES (28, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:33:43');
INSERT INTO `sys_logininfor` VALUES (29, 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '退出成功', '2020-03-01 15:34:33');
INSERT INTO `sys_logininfor` VALUES (30, 'proptest', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', '0', '登录成功', '2020-03-01 15:34:37');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '在线用户', 7, 'com.pepper.project.monitor.online.controller.UserOnlineController.batchForceLogout()', 'POST', 1, 'hant', '测试部门', '/monitor/online/batchForceLogout', '127.0.0.1', '内网IP', '{\"ids[]\":[\"5c3f637c-c9c3-445f-bbf7-1712f0a4a53a\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:04:13');
INSERT INTO `sys_oper_log` VALUES (2, '用户管理', 1, 'com.pepper.project.system.user.controller.UserController.addSave()', 'POST', 1, 'admin', '超级管理员', '/system/user/add', '127.0.0.1', '内网IP', '{\"deptId\":[\"111\"],\"userName\":[\"hospitaltest\"],\"deptName\":[\"医院管理员\"],\"phonenumber\":[\"18978786000\"],\"email\":[\"hospitaltes@1212.com\"],\"loginName\":[\"hospitaltest\"],\"passOrigin\":[\"hospitaltest\"],\"sex\":[\"0\"],\"roleId\":[\"105\"],\"areaId\":[\"100000\"],\"merchantName\":[\"admin123yiyuanyiyuan\"],\"remark\":[\"\"],\"status\":[\"0\"],\"postIds\":[\"\"],\"password\":[\"6c136fd1bb22aab62585810f14ec251b\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:19:11');
INSERT INTO `sys_oper_log` VALUES (3, '商户信息user', 2, 'com.pepper.project.system.user.controller.ProfileController.updateMerchant()', 'POST', 1, 'hospitaltest', '医院管理员', '/system/user/profile/updateMerchant', '127.0.0.1', '内网IP', '{\"merchantId\":[\"300000\"],\"merchantName\":[\"admin123yiyuanyiyuan\"],\"merchantIntroduce\":[\"这是一个医院！111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:19:33');
INSERT INTO `sys_oper_log` VALUES (4, '商户信息user', 2, 'com.pepper.project.system.user.controller.ProfileController.updateMerchant()', 'POST', 1, 'hospitaltest', '医院管理员', '/system/user/profile/updateMerchant', '127.0.0.1', '内网IP', '{\"merchantId\":[\"300000\"],\"merchantName\":[\"1\"],\"merchantIntroduce\":[\"这是一个医院！111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:19:47');
INSERT INTO `sys_oper_log` VALUES (5, '区域设置', 1, 'com.pepper.project.csc.area.controller.AreaController.addSave()', 'POST', 1, 'admin', '超级管理员', '/csc/area/add', '127.0.0.1', '内网IP', '{\"areaCode\":[\"SYBK\"],\"areaName\":[\"沙依巴克区\"],\"coordinate\":[\"10.00090,89.89009\"],\"status\":[\"0\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:23:37');
INSERT INTO `sys_oper_log` VALUES (6, '用户管理', 1, 'com.pepper.project.system.user.controller.UserController.addSave()', 'POST', 1, 'admin', '超级管理员', '/system/user/add', '127.0.0.1', '内网IP', '{\"deptId\":[\"104\"],\"userName\":[\"comutest\"],\"deptName\":[\"社区管理员\"],\"phonenumber\":[\"18978786543\"],\"email\":[\"comutest@163.com\"],\"loginName\":[\"comutest\"],\"passOrigin\":[\"comutest\"],\"sex\":[\"0\"],\"roleId\":[\"104\"],\"areaId\":[\"100000\"],\"merchantName\":[\"comutest,社区管理员\"],\"remark\":[\"comutest\"],\"status\":[\"0\"],\"postIds\":[\"4\"],\"password\":[\"9a0112ee6a8d875810064874fdfe026a\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:24:33');
INSERT INTO `sys_oper_log` VALUES (7, '用户管理', 1, 'com.pepper.project.system.user.controller.UserController.addSave()', 'POST', 1, 'admin', '超级管理员', '/system/user/add', '127.0.0.1', '内网IP', '{\"deptId\":[\"111\"],\"userName\":[\"hostest\"],\"deptName\":[\"医院管理员\"],\"phonenumber\":[\"18978786541\"],\"email\":[\"hostest@163.com\"],\"loginName\":[\"hostest\"],\"passOrigin\":[\"hostest\"],\"sex\":[\"1\"],\"roleId\":[\"105\"],\"areaId\":[\"\"],\"merchantName\":[\"hostest,医院管理员\"],\"remark\":[\"hostest\"],\"status\":[\"0\"],\"postIds\":[\"4\"],\"password\":[\"d6e3055c442065950504c9626633aa83\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:26:05');
INSERT INTO `sys_oper_log` VALUES (8, '用户管理', 2, 'com.pepper.project.system.user.controller.UserController.editSave()', 'POST', 1, 'admin', '超级管理员', '/system/user/edit', '127.0.0.1', '内网IP', '{\"userId\":[\"600000001\"],\"deptId\":[\"111\"],\"merchantFlag\":[\"2\"],\"merchantId\":[\"300000\"],\"userName\":[\"hostest\"],\"dept.deptName\":[\"医院管理员\"],\"phonenumber\":[\"18978786541\"],\"email\":[\"hostest@163.com\"],\"loginName\":[\"hostest\"],\"sex\":[\"1\"],\"areaId\":[\"100000\"],\"merchantName\":[\"hostest,医院管理员\"],\"remark\":[\"hostest\"],\"status\":[\"0\"],\"postIds\":[\"4\"],\"roleId\":[\"\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:29:54');
INSERT INTO `sys_oper_log` VALUES (9, '用户管理', 1, 'com.pepper.project.system.user.controller.UserController.addSave()', 'POST', 1, 'admin', '超级管理员', '/system/user/add', '127.0.0.1', '内网IP', '{\"deptId\":[\"111\"],\"userName\":[\"hostest1\"],\"deptName\":[\"医院管理员\"],\"phonenumber\":[\"18978786535\"],\"email\":[\"hostest1@1212.com\"],\"loginName\":[\"hostest1\"],\"passOrigin\":[\"hostest1\"],\"sex\":[\"0\"],\"roleId\":[\"105\"],\"areaId\":[\"100000\"],\"merchantName\":[\"hostest1,医院管理员\"],\"remark\":[\"\"],\"status\":[\"0\"],\"postIds\":[\"4\"],\"password\":[\"5435c178c86a893847cc49eccb75b5c2\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:32:45');
INSERT INTO `sys_oper_log` VALUES (10, '用户管理', 1, 'com.pepper.project.system.user.controller.UserController.addSave()', 'POST', 1, 'admin', '超级管理员', '/system/user/add', '127.0.0.1', '内网IP', '{\"deptId\":[\"110\"],\"userName\":[\"proptest\"],\"deptName\":[\"物业管理员\"],\"phonenumber\":[\"18978786511\"],\"email\":[\"proptest@163.com\"],\"loginName\":[\"proptest\"],\"passOrigin\":[\"proptest\"],\"sex\":[\"0\"],\"roleId\":[\"106\"],\"areaId\":[\"100000\"],\"merchantName\":[\"物业管理员\"],\"remark\":[\"proptest\"],\"status\":[\"0\"],\"postIds\":[\"4\"],\"password\":[\"706599270e6c121de2b80ab71f24a0f5\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2020-03-01 15:34:29');
...
CREATE TABLE `sys_user`  (
  ...
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 600000004 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '韩结涛', '00', 'admin@163.com', '15888888888', '1', '/profile/avatar/2020/02/17/1d3120d56f3e28a7012ff5b05a36bfd7.png', 'cbc030ef6fc74743fda36e2f76d6908b', '111111', '0', '0', '127.0.0.1', '2020-03-01 15:33:43', 'admin', '2018-03-16 11:33:00', 'admin', '2020-03-01 15:33:43', '管理员', 0, 0, 'fcea920f7412b5da7be0cf42b8c93759');
INSERT INTO `sys_user` VALUES (2, 105, 'hant', 'hant', '00', 'hant@qq.com', '15666666666', '1', '', '19486052ecdfd0df9aa0b6f306cd962c', '546af6', '0', '0', '127.0.0.1', '2020-03-01 15:03:53', 'admin', '2018-03-16 11:33:00', 'admin', '2020-03-01 15:03:52', '测试员', 0, 0, 'db846859bcf906caf61ba74e22953a80');
INSERT INTO `sys_user` VALUES (600000000, 104, 'comutest', 'comutest', '00', 'comutest@163.com', '18978786543', '0', '', '7b9895fdf284edb973c11f06f665be6b', 'a2c89e', '0', '0', '127.0.0.1', '2020-03-01 15:24:43', 'admin', '2020-03-01 15:24:33', '', '2020-03-01 15:24:42', 'comutest', 1, 200000, '9a0112ee6a8d875810064874fdfe026a');
INSERT INTO `sys_user` VALUES (600000001, 111, 'hostest', 'hostest', '00', 'hostest@163.com', '18978786541', '1', '', '1f52f3cc1bd89b0318cc9319ca8a3e11', 'f21e3e', '0', '0', '127.0.0.1', '2020-03-01 15:30:25', 'admin', '2020-03-01 15:26:05', 'admin', '2020-03-01 15:30:25', 'hostest', 2, 300000, 'd6e3055c442065950504c9626633aa83');
INSERT INTO `sys_user` VALUES (600000002, 111, 'hostest1', 'hostest1', '00', 'hostest1@1212.com', '18978786535', '0', '', 'ee3048763a57eea973ba6fb6dc22b922', '2de55b', '0', '0', '127.0.0.1', '2020-03-01 15:32:53', 'admin', '2020-03-01 15:32:45', '', '2020-03-01 15:32:53', NULL, 2, 300001, '5435c178c86a893847cc49eccb75b5c2');
INSERT INTO `sys_user` VALUES (600000003, 110, 'proptest', 'proptest', '00', 'proptest@163.com', '18978786511', '0', '', '9e77ed99a8b6645ef5a3a241b93770b2', '10bd2e', '0', '0', '127.0.0.1', '2020-03-01 15:34:38', 'admin', '2020-03-01 15:34:29', '', '2020-03-01 15:34:37', 'proptest', 3, 400000, '706599270e6c121de2b80ab71f24a0f5');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('fc591e38-37f9-4d28-bbca-e6f2422677b4', 'proptest', '物业管理员', '127.0.0.1', '内网IP', 'Chrome', 'Windows 10', 'on_line', '2020-03-01 15:34:33', '2020-03-01 15:34:38', 1800000);
...
INSERT INTO `sys_user_post` VALUES (600000000, 4);
INSERT INTO `sys_user_post` VALUES (600000001, 4);
INSERT INTO `sys_user_post` VALUES (600000002, 4);
INSERT INTO `sys_user_post` VALUES (600000003, 4);
