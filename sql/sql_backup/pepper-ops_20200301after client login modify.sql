...
CREATE TABLE `ch_doctor`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '医生管理 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ch_hospital`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 300000 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区服务服务中心-医院介绍 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ch_medical_project`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '医疗项目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_business_guide`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区办事指南 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `cm_community`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 200002 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区 ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cm_community
-- ----------------------------
INSERT INTO `cm_community` VALUES (200000, '200000', 'shequddddmd5test', 100000, '这是一个社区！', '0', 'admin', '2020-03-01 10:37:31', 'admin', '2020-03-01 10:37:31');
INSERT INTO `cm_community` VALUES (200001, '200001', 'shequ111', 100000, '这是一个社区！12213231211111', '0', 'admin', '2020-03-01 11:10:07', 'md5test1', '2020-03-01 11:28:38');
...
-- Records of csc_area
-- ----------------------------
INSERT INTO `csc_area` VALUES (100000, 'SYBK', '沙依巴克区', '11.090493,89.233423', '0', 'admin', '2020-02-24 14:21:15', 'admin', '2020-02-24 14:21:15');
...
CREATE TABLE `he_board`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '健康宣教板块 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_business_guide`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '办事指南 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_notice`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物业通知 ' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pm_property`  (
  ...
  `UPDATE_TIME` datetime(0) DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 400006 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '物业 ' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pm_property
-- ----------------------------
INSERT INTO `pm_property` VALUES (400000, '400000', '1111', 100000, '这是一个物业！', '0', 'admin', '2020-02-29 20:05:46', 'admin', '2020-02-29 20:05:46');
INSERT INTO `pm_property` VALUES (400001, '400001', 'admin123yiyuanyiyuan', 100000, '这是一个物业！', '0', 'admin', '2020-02-29 20:29:35', 'admin', '2020-02-29 20:29:35');
INSERT INTO `pm_property` VALUES (400002, '400002', 'admin123yiyuanyiyuan', 100000, '这是一个物业！', '0', 'admin', '2020-02-29 20:30:53', 'admin', '2020-02-29 20:30:53');
INSERT INTO `pm_property` VALUES (400003, '400003', 'admin123yiyuanyiyuan', 100000, '这是一个物业！', '0', 'admin', '2020-02-29 20:33:49', 'admin', '2020-02-29 20:33:49');
INSERT INTO `pm_property` VALUES (400004, '400004', 'dfsdfsdfsd', 100000, '这是一个物业！', '0', 'admin', '2020-02-29 20:45:13', 'admin', '2020-02-29 20:45:13');
INSERT INTO `pm_property` VALUES (400005, '400005', '1111', 100000, '这是一个物业！', '0', 'admin', '2020-02-29 20:47:01', 'admin', '2020-02-29 20:47:01');
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-QGR3FOO1583046820339', 1583046975125, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1583046820000, -1, 5, 'PAUSED', 'CRON', 1583046820000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1583046825000, -1, 5, 'PAUSED', 'CRON', 1583046820000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1583046820000, -1, 5, 'PAUSED', 'CRON', 1583046820000, 0, NULL, 2, '');
...
CREATE TABLE `sm_client_user`  (
  ...
  PRIMARY KEY (`USER_ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10000030 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户会员表 system memeber' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sm_client_user
-- ----------------------------
INSERT INTO `sm_client_user` VALUES (10000005, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 15:50:16', '2020-02-28 15:50:16', NULL, NULL, '2020-02-28 15:50:16', NULL, '2020-02-28 15:50:16', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000006, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 15:56:02', '2020-02-28 15:56:02', NULL, NULL, '2020-02-28 15:56:02', NULL, '2020-02-28 15:56:02', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000007, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 15:56:52', '2020-02-28 15:56:52', NULL, NULL, '2020-02-28 15:56:52', NULL, '2020-02-28 15:56:52', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000008, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:00:09', '2020-02-28 16:00:09', NULL, NULL, '2020-02-28 16:00:09', NULL, '2020-02-28 16:00:09', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000009, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:00:39', '2020-02-28 16:00:39', NULL, NULL, '2020-02-28 16:00:39', NULL, '2020-02-28 16:00:39', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000010, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:02:55', '2020-02-28 16:02:55', NULL, NULL, '2020-02-28 16:02:55', NULL, '2020-02-28 16:02:55', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000011, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:03:32', '2020-02-28 16:03:32', NULL, NULL, '2020-02-28 16:03:32', NULL, '2020-02-28 16:03:32', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000012, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:06:36', '2020-02-28 16:06:36', NULL, NULL, '2020-02-28 16:06:36', NULL, '2020-02-28 16:06:36', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000013, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:15:21', '2020-02-28 16:15:21', NULL, NULL, '2020-02-28 16:15:21', NULL, '2020-02-28 16:15:21', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000014, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:18:07', '2020-02-28 16:18:07', NULL, NULL, '2020-02-28 16:18:07', NULL, '2020-02-28 16:18:07', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000015, 'vnull', NULL, NULL, NULL, NULL, NULL, '2', NULL, '2020-02-28 16:39:42', '2020-02-28 16:39:42', NULL, NULL, '2020-02-28 16:39:42', NULL, '2020-02-28 16:39:42', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000023, 'ch_600000007', NULL, NULL, NULL, 'ch_600000007', NULL, '2', NULL, '2020-02-28 17:13:10', '2020-02-28 17:13:10', NULL, NULL, '2020-02-28 17:13:10', NULL, '2020-02-28 17:13:10', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000024, 'ch_600000008', NULL, NULL, NULL, 'ch_600000008', NULL, '2', NULL, '2020-02-28 17:17:07', '2020-02-28 17:17:07', NULL, NULL, '2020-02-28 17:17:07', NULL, '2020-02-28 17:17:07', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000025, 'ch_600000009', NULL, NULL, NULL, 'ch_600000009', '15888888881', '2', NULL, '2020-02-28 19:00:55', '2020-02-28 19:00:55', NULL, NULL, '2020-02-28 19:00:55', NULL, '2020-02-28 19:01:09', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000026, 'ch_600000010', NULL, NULL, NULL, 'ch_600000010', '15888888882', '2', NULL, '2020-02-28 19:04:50', '2020-02-28 19:04:50', NULL, NULL, '2020-02-28 19:04:50', NULL, '2020-02-28 19:04:50', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000027, 'ch_600000011', NULL, NULL, NULL, 'ch_600000011', '15888881115', '2', NULL, '2020-02-28 19:44:14', '2020-02-28 19:44:14', NULL, NULL, '2020-02-28 19:44:14', NULL, '2020-02-28 19:44:14', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000028, 'ch_600000020', NULL, NULL, NULL, 'ch_600000020', '18978786556', '2', NULL, '2020-03-01 14:24:10', '2020-03-01 14:24:10', NULL, NULL, '2020-03-01 14:24:10', NULL, '2020-03-01 14:24:10', NULL, NULL, NULL);
INSERT INTO `sm_client_user` VALUES (10000029, 'ch_600000021', NULL, NULL, NULL, 'ch_600000021', '18978786557', '2', NULL, '2020-03-01 14:28:00', '2020-03-01 14:28:00', NULL, NULL, '2020-03-01 14:28:00', NULL, '2020-03-01 14:28:00', NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  PRIMARY KEY (`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 600000022 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '韩结涛', '00', 'admin@163.com', '15888888888', '1', '/profile/avatar/2020/02/17/1d3120d56f3e28a7012ff5b05a36bfd7.png', 'cbc030ef6fc74743fda36e2f76d6908b', '111111', '0', '0', '127.0.0.1', '2020-03-01 15:14:08', 'admin', '2018-03-16 11:33:00', 'admin', '2020-03-01 15:14:08', '管理员', 0, 0, 'fcea920f7412b5da7be0cf42b8c93759');
